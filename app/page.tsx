  ...
  return (
    <>
      <nav className="fixed top-0 left-0 w-full z-50 flex justify-between items-center p-6 md:p-8 backdrop-blur-md border-black/5 transition-all duration-300">
        <a
          target="_blank"
          href="https://tribecadentalstudio.com"
          className="text-[#B8860B] font-serif text-lg md:text-xl tracking-[0.2em] hover:text-[#B8860B] transition-colors uppercase"
        >
      ...
      <div className="bg-[#FAF9F6] text-[#2C3539] font-serif">
        <section className="relative h-screen flex flex-col justify-center items-center text-center p-6 overflow-hidden">
          ...
          <div className="relative z-10 text-white max-w-4xl">
            ...
            <p className="max-w-xl mx-auto text-lg md:text-xl mb-10 leading-relaxed opacity-90 font-light drop-shadow-lg">
              When a dental emergency strikes, you deserve precision, comfort,
              and the immediate attention of the city’s finest clinical team.
            </p>
        ...
        <section className="py-32 px-6 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-20">
          <div className="flex-1 space-y-8">
            <h2 className="text-4xl md:text-5xl font-light leading-tight">
              Gentle and caring
              <br />
              way of getting you out of pain
            </h2>
            <p className="text-xl text-gray-600 leading-relaxed font-light">
              In the heart of Tribeca, we treat emergencies not as
              interruptions, but as an opportunity for precision restoration.
              Using advanced diagnostic imaging and laser technology, we resolve
              pain with advanced treatment options and gentle care.
            </p>
            <div className="pt-4 border-t border-gray-200">
              <p className="text-sm uppercase tracking-widest text-[#B8860B] font-bold">
                Technology Spotlight
              </p>
              <p className="text-gray-500">
                Fotona Laser & 3D CBCT Airway Mapping
              </p>
            </div>
          </div>
        ...
        <section className="py-32 bg-[#F4F4F4] text-center border-y border-gray-100">
          <h2 className="text-4xl font-light mb-20 tracking-tight text-[#2C3539]">
            ...
            {[
              {
                ...
                desc: "Speak directly with our clinical team to prioritize your urgent case.",
              },
              {
                step: "02",
                title: "Precision Imaging",
                desc: "Advanced digital mapping to pinpoint the exact source of discomfort.",
              },
              {
                step: "03",
                title: "Restorative Relief",
                desc: "Immediate, high-end intervention to restore your oral health and comfort.",
              },
            ].map((item, i) => (
              <div
                key={i}
              ...
              >
                <span className="text-xs uppercase tracking-[0.3em] text-[#B8860B] font-bold border-b border-[#B8860B] pb-2">
                  Phase {item.step}
                </span>
